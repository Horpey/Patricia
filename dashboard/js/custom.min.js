$(document).ready(function () {
    ...
    $(function () {
            ...
            var i = function () {
                    var i = 60,
                        l = this.window.innerWidth > 0 ? this.window.innerWidth : this.screen.width,
                        s = (this.window.innerHeight > 0 ? this.window.innerHeight : this.screen.height) - 1;
